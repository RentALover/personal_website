...
function Developer() {
  return (
    <span className="group">
      <span className="font-mono">&lt;</span>Student
...
function Designer() {
  return (
    <span className="group relative inline-block bg-black/5 p-1 whitespace-nowrap dark:bg-white/5">
  ...
  return (
    <div className="max-w-2xl">
      ...
      >
        ...
        /> */}
        <SocialLink
          href="https://github.com/RentALover"
        ...
        <SocialLink
          href="mailto:yuzhao.zhang@u.nus.edu"
          aria-label="我的邮箱"
          platform="mail"
        />
      </motion.div>
